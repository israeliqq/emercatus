				...
				<div class="top-control box-has-content">
					<div class="control">
						...
						<div class="control-button">
							<a href="#" class="grid-button active"><span class="icon"><i class="fa fa-th-large" aria-hidden="true"></i> </span>Cuadrícula</a>
							<a href="#" class="list-button"><span class="icon"><i class="fa fa-th-list" aria-hidden="true"></i></span> Lista</a>
						</div>
					</div>
				</div>
